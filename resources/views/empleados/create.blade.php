                    ...
                    <form method="POST" action="{{ route('empleados.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="posicion" class="block mt-1 w-full" type="text" name="posicion" :value="old('posicion')" required />
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="direccion" name="direccion" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" rows="3" required>{{ old('direccion') }}</textarea>
                            ...
                            <div>
                                ...
                                <x-text-input id="fecha_terminacion" class="block mt-1 w-full" type="date" name="fecha_terminacion" :value="old('fecha_terminacion')" />
                                <x-input-error :messages="$errors->get('fecha_terminacion')" class="mt-2" />
                            </div>

                            <div class="md:col-span-2">
                                <p class="text-sm text-gray-500">El estado se asigna automáticamente: <strong>Activo</strong> sin fecha de terminación, <strong>Cancelado</strong> si se indica fecha de terminación.</p>
                            </div>
                        </div>
