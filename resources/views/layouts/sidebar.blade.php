...
>
    ...
    <nav class="mt-5 flex-1 px-4 text-sm font-medium">
        ...
        @foreach([
            ['label' => 'Ventas', 'icon' => 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', 'route' => 'ventas.index'],
            ...
            <a href="{{ $item['route'] ? route($item['route']) : '#' }}" class="group mb-1 flex items-center rounded-lg px-4 py-2.5 text-slate-300 transition-all hover:bg-white/10 hover:text-white {{ $item['route'] && request()->routeIs($item['route']) ? 'bg-gradient-to-r from-blue-500 to-indigo-500 text-white shadow-lg shadow-blue-900/40' : '' }}">
        ...
        <p class="mb-2 ml-2 mt-6 text-[10px] font-bold uppercase tracking-widest text-slate-500">Tienda</p>

        <a href="{{ route('pos.index') }}" class="group mb-1 flex items-center rounded-lg px-4 py-2.5 transition-all {{ $navLink(request()->routeIs('pos.*')) }}">
            <svg class="{{ $navIcon(request()->routeIs('pos.*')) }} mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
            Punto de Venta
        </a>

        <a href="{{ route('productos.index') }}" class="group mb-1 flex items-center rounded-lg px-4 py-2.5 transition-all {{ $navLink(request()->routeIs('productos.*')) }}">
            <svg class="{{ $navIcon(request()->routeIs('productos.*')) }} mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>
            Productos
        </a>
